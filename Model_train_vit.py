...
from network.vit_model import AutoEncoder
import os
...
if __name__ == '__main__':
    ...
    decoder_path = f'./output/baseline/weights/decoder.pth.tar'
    model.decoder.load_state_dict(torch.load(decoder_path, map_location='cpu')['state_dict'])
    print(f'Load decoder in {decoder_path}')
    torch.save({'state_dict': model.state_dict(), }, f'{save_root}/autoencoder.pth.tar')
